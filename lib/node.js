...
class HttpResponse {
     ...
     * @return {Result<string, HttpResponse>}
     */
...
class Node {
    ...
    async getBlockNumber() {
        ...
        if (r2.error) {
            return Result.badError(NODE_BAD_RESPONSE, r2.error, r1.data)
        }
        let {data: rpcResponse} = r1
        let {data: blockNumber} = r2
        let data = new NodeResponse(
            blockNumber, rpcResponse.time, rpcResponse.size
        )
        return Result.ok(data)
    }
    ...
    async getBlockByNumber(blockNumber) {
        ...
        let {data: block} = r2
        let data = new NodeResponse(block, rpcResponse.time, rpcResponse.size)
        return Result.ok(data)
    }
    ...
    async getTransactionByHash(hash) {
        ...
        let data = new NodeResponse(
            transaction, rpcResponse.time, rpcResponse.size
        )
        return Result.ok(data)
    }
    ...
    async getLogs(filter) {
        ...
        let {data: logs} = r2
        let data = new NodeResponse(
            logs, rpcResponse.time, rpcResponse.size
        )
        return Result.ok(data)
    }
