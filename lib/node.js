...
class Node {
     ...
     * standard error codes such as: -32700, -32600, -32601, -32602. It does
     * not define it's own too. Because of that, there is no way to clarify
     * error comes from client or sever. Thus, all valid error responses
     * without code is consider as `CODE_BAD_REQUEST`. Invalid error responses
     * is consider as `CODE_BAD_RESPONSE`.
     *
